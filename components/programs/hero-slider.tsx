...
export function HeroSlider({
  ...
  if (!safeSlides.length) {
    return (
      <div className="relative mx-auto w-full overflow-hidden rounded-2xl border border-border/70 bg-[linear-gradient(125deg,rgba(15,23,42,0.95),rgba(8,47,73,0.85))]" style={{ height: `${heightPx}px`, maxWidth: `${widthPx}px`, width: "100%" }}>
  ...
  return (
    <div className="relative mx-auto w-full overflow-hidden rounded-2xl border border-border/70 bg-slate-950" style={{ height: `${heightPx}px`, maxWidth: `${widthPx}px`, width: "100%" }}>
